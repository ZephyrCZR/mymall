<template>
  <div id="home">
    <nav-bar class="home-nav"><template #center>
        <div>购物街</div>
      </template></nav-bar>
    <tab-control id="tab-control" ref="tabControlTop" :titles="['流行','新款','精选']" @tabClick="tabClick"
      v-show="showTabControl" />
    <scroll class="home-scroll" ref="scroll" :probe-type="3" :pull-up-load="true" @scroll="onScroll"
      @pullingUp="loadMore">
